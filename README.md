...
Download a binary for your OS from [release page](https://github.com/naterator/notes/releases). Put the executable in a directory in `$PATH`.

Or you can install by building from source directly as follows. Go 1.24 or later is necessary.
...
- [`notes`: CLI tool for taking \& managing notes in Markdown format](#notes-cli-tool-for-taking--managing-notes-in-markdown-format)
  ...
  - [FAQ](#faq)
    ...
    - [Is it possible to use `--color-always` by default?](#is-it-possible-to-use---color-always-by-default)
...
creates a note file at `<HOME>/notes/blog/how-to-handle-files.md`. The home directory is automatically
created.
...
```
/Users/me/.local/share/notes/blog/how-to-handle-files.md
```
...
It saves all your notes under your `notes` directory as Git repository.
...
You can try [Vim plugin for notes](https://github.com/rhysd/vim-notes)
...
[codecov-badge]: https://codecov.io/gh/naterator/notes/branch/master/graph/badge.svg
[codecov]: https://codecov.io/gh/naterator/notes
[doc-badge]: https://godoc.org/github.com/naterator/notes?status.svg
[doc]: http://godoc.org/github.com/naterator/notes
[github-actions-badge]: https://github.com/naterator/notes/workflows/CI/badge.svg?branch=master&event=push
[github-actions]: https://github.com/naterator/notes/actions?query=workflow%3ACI
